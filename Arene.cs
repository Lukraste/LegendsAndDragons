...
namespace LegendsAndDragons
{
    internal class Arene
    {
        ...
        public Entity[] Combattants { get; set; } = new Entity[2];
        ...
        public void ajouteCombatants(Hero joueur, Monstre monstre)
        {
        ...
        public void AfficheRoundDebut() 
        {
            ...
            do
            {
                ...
                Console.WriteLine("Combattant : " + ((Hero)Combattants[0]).NameClass + " " + Combattants[0].Name + " VS " + Combattants[1].Name + "\n");
                ...
                Console.WriteLine("Nom Arme: " + ((Hero)Combattants[0]).HeroWeapon.Name);
                Console.WriteLine("Element Arme: " + ((Hero)Combattants[0]).HeroWeapon.Element);
                Console.WriteLine("Puissance Arme: " + ((Hero)Combattants[0]).HeroWeapon.Damage);
                Console.WriteLine();
                ...
                if (Combattants[0].Vie > Combattants[0].MaxVie)
                {
                    Combattants[0].Vie = Combattants[0].MaxVie;
                }
                if (Combattants[1].Vie > Combattants[1].MaxVie)
                {
                    Combattants[1].Vie = Combattants[1].MaxVie;
                }
        ...
        {
            Random rnd = new Random();
            Combattants[0].SoinRecu+= rnd.Next(1, 10)* Combattants[0].Level;

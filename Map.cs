...
namespace LegendsAndDragons
{
    internal class Map
    {
        ...
        public Map(List<Monstre> grpMonstresForetNord, List<Monstre> grpMonstresPlaineNord,
                ...
                List<Monstre> grpMonstresPlaineSud, List<Monstre> grpMonstresMontagneSud, Hero joueur)
        {
       ...
       public void AddMonstresSurMap(List<Monstre> groupeMonstres)
        ...
        public void AfficheMap()
        {
            ...
            Console.WriteLine(joueurMap.NameClass+" "+joueurMap.Name+"\t\t\tArme: "+joueurMap.HeroWeapon.Name+"\t\tVie : "+joueurMap.Vie);
        ...
        public void RejoindreAreneDeCombat(Hero jouer, Monstre monstre)
        {
